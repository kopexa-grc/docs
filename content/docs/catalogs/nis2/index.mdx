...
description: Umsetzung der EU NIS2-Anforderungen und Kontrollen in Kopexa
---
...
| Risikoanalyse & Behandlung | Risiko-Modul + Risiko-Matrix + Kontrollen + Work Items |
| Incident Handling (24h/72h Meldung) | Incident-Module + Vorfallsregister (Work Items) |
| BC/DR-Plan & Backup | Dokument + Work Items + Kontrollen (Backup-Test) |
| Lieferkettensicherheit | Vendor-Assets + Risikobewertung + Nachweise |
| Zugriffsmanagement & MFA | Asset-Modul + Access-Policy + MFA-Kontrolle |
| Awareness & Schulungen | Dokument (Policy) + Trainings-Modul + Nachweis |
| Kontinuierliche Überwachung | Audit-Work Items + Kontroll-Reviews + Reports |
...
- **Plan:** Policies, Risikoanalyse, Kontrollen planen
...
- Verknüpfe mit Assets (z. B. Cloud-Plattform) und Kontrollen (z. B. Zugriffskontrolle)
...
- Access-Kontroll-Policy
- Vendor-Security-Policy
- Audit-/Review-Protokolle

> Alle als Dokumente + verknüpfte Nachweise in Kopexa abbilden.
...
> **Hinweis:** NIS2-Kontrollen sind in Kopexa bereits als Framework verfügbar.  
