...
- **SSO für alle:** Jede [Organization](./organization.mdx), unabhängig vom Tarif, kann [SAML](./domains.mdx) und OIDC nutzen. Security ist bei uns kein Enterprise-Add-on.
...
- [Organization](./organization.mdx) – Zentrale Verwaltung von Benutzern, SSO und Lizenzen  
