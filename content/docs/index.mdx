...
1. [**Erste Schritte (Organization)**](./organization) – Lege deine Organization an, verifiziere Domains und richte SSO ein.  
2. [**Spaces & Inventory**](./spaces) – Baue deine Arbeitsbereiche auf, erfasse Assets, Domains und Personen.  
3. [**User**](./user) – Alles für Endnutzer:innen: Konto, Profil, Benachrichtigungen, Zugriff.  
4. [**Frameworks & Controls**](./spaces) – Nutze ISO 27001, DSGVO, TISAX & Co. oder bring eigene Kontrollen ein.  
5. [**Risiken & Maßnahmen**](./spaces) – Identifiziere Risiken, plane Maßnahmen und dokumentiere Nachweise.  
6. [**Sicherheit & SSO**](./organization/security) – Lerne, wie Kopexa deine Daten schützt und wie du SSO einrichtest.
