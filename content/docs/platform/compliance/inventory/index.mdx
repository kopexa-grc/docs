...
Viele Kopexa-Features bauen direkt auf dem Inventory auf (Risiken, Kontrollen, Nachweise, Issues).

> **Scope:** Inventory gehört zum Space (siehe [Spaces](../../quickstart/spaces.mdx)). Zentrale SSO-Domains verwaltest du auf **Organization**-Ebene (siehe [Domains](../../quickstart/organization/domains/index.mdx)).
...
- **Verknüpfbar:** Assets verbinden sich mit **Risks**, **Kontrollen**, **Documents/Nachweis** und **Issues**.
...
> **SSO-Domains** für Login/Zuordnung verwaltest du auf **Organization-Ebene** (siehe [Domains](../../quickstart/organization/domains/index.mdx)).
...
- **Beziehungen** – Verweise auf Vendors, Risks, Kontrollen, Documents/Nachweis
...
Sie können mit **Risks**, **Issues** (Maßnahmen) und **Documents/Nachweis** (Nachweise) verknüpft werden.

---

## Beziehungen zu anderen Modulen

- **Risks:** Risiken werden häufig **an Assets** bewertet und mit **Kontrollen** verknüpft.  
- **Catalogs & Kontrollen:** Kontrollen adressieren Anforderungen (ISO, DSGVO, TISAX) und referenzieren relevante Assets.  
- **Documents & Nachweis:** Policies, Verfahren und Nachweise verweisen auf betroffene Assets.  
