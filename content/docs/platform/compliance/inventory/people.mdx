...
> **Scope:** People gehören zum Space (siehe [Spaces](../../quickstart/spaces.mdx)).  
> Zentrale **SSO-Domains** verwaltest du auf **Organization-Ebene** (siehe [Domains](../../quickstart/organization/domains/index.mdx)).
