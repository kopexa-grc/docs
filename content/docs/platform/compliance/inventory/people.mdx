...
- **Zuweisungen/Beziehungen** zu Assets, Vendors, Risks, Kontrollen und Issues herstellen.
...
- **Catalogs & Kontrollen:** Zuweisung von Kontrollen (z. B. Rezertifizierungs-Intervalle, Least-Privilege).  
- **Documents & Nachweis:** Policy-Acknowledgements, Schulungsnachweise, Offboarding-Nachweise.  
