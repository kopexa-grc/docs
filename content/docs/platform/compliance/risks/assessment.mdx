...
description: Leitfaden zur Einstufung von Wahrscheinlichkeit und Konsequenz in Kopexa
---
...
- **Konsequenz (Impact)** – Welche Folgen hätte es für dein Unternehmen?
...
> **Score = Konsequenz × Wahrscheinlichkeit** → typischer Bereich **1–20**.  
...
| **2 Niedrig** | Begrenzte Konsequenzen? | Kurzer Service-Hiccup, geringe Kosten |
...
- **Initial:** Konsequenz **3 Mittel**, Wahrscheinlichkeit **3 Hoch** → **Score 9 (Mittel)**
- **Maßnahmen:** TLS ≥ 1.2 erzwingen, schwache Cipher deaktivieren, FS aktivieren; Konfig-PR & sslyze-Report als Nachweis
- **Restrisiko:** Konsequenz **3**, Wahrscheinlichkeit **1 Niedrig** → **Score 3**
...
- **Initial:** Konsequenz **4 Hoch**, Wahrscheinlichkeit **2 Mittel** → **Score 8**
- **Maßnahmen:** Bucket-Policy schließen, Block Public Access, CI-Policy Check; CloudTrail-Nachweis
- **Restrisiko:** Konsequenz **4**, Wahrscheinlichkeit **0.5 Sehr niedrig** → **Score 2**
- **Erläuterung:** Restrisiko verbleibt durch menschliche Fehler; Prävention/Detektion verbessert.

### 3) Phishing ohne MFA
- **Initial:** Konsequenz **4 Hoch**, Wahrscheinlichkeit **4 Sehr hoch** → **Score 16 (Kritisch)**
- **Maßnahmen:** MFA für alle, Phishing-Simulator, Awareness-Training, Conditional Access
- **Restrisiko:** Konsequenz **4**, Wahrscheinlichkeit **1 Niedrig** → **Score 4**
- **Erläuterung:** Zielte Angriffe möglich, aber Wahrscheinlichkeit stark gesenkt.

### 4) Drittanbieter-Ausfall (kritischer SaaS)
- **Initial:** Konsequenz **4 Hoch**, Wahrscheinlichkeit **2 Mittel** → **Score 8**
- **Maßnahmen:** Vertragliche SLA, zweiter Anbieter/Failover, Datenauszug/Backups testen
- **Restrisiko:** Konsequenz **3 Mittel**, Wahrscheinlichkeit **1 Niedrig** → **Score 3**
...
- **Restrisiko:** Konsequenz **2 Niedrig**, Wahrscheinlichkeit **1 Niedrig** → **Score 2**
...
- **Nachweise sammeln:** Bewertung begründen (Kommentare) und **Nachweis** anhängen.
- **Regelmäßig prüfen:** Bei Reviews/Rezertifizierungen **Konsequenz/Wahrscheinlichkeit** neu bewerten.
