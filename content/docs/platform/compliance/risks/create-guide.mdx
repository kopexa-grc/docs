...
Mit **Risks** identifizierst, bewertest und behandelst du Risiken in deinem Space – verknüpft mit **Assets**, **Kontrollen**, **Nachweis** und **Work Items**.  
...
<Accordions type="single">
  ...
  <Accordion title="Restrisiko bleibt unverändert.">
    Maßnahmen (Work Items) sind ggf. noch **offen** oder **Nachweis** fehlt. Nachpflegen, dann neu bewerten.
  </Accordion>
