---
title: Programme
description: Programme koordinieren Compliance-Aktivitäten, Kontrollen und Nachweise für Zertifizierungen, Audits und laufende Compliance
---
...
<Accordions>
  <Accordion title="Kann ich ein Programm pausieren?">
    Ja. Du kannst den Status auf "Pausiert" setzen. Kontrollen und Maßnahmen bleiben erhalten, aber Erinnerungen werden deaktiviert.
  </Accordion>
  <Accordion title="Was passiert nach Abschluss eines Programms?">
    Das Programm wird archiviert. Alle Kontrollen, Maßnahmen und Nachweise bleiben als historische Referenz erhalten. Für das nächste Audit erstellst du ein neues Programm.
  </Accordion>
  <Accordion title="Kann ich Kontrollen zwischen Programmen teilen?">
    Maßnahmen und Nachweise können programmübergreifend verknüpft werden. Die Kontrollen selbst gehören zum jeweiligen Programm, aber die Umsetzung (Maßnahme) ist wiederverwendbar.
  </Accordion>
