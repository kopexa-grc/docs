...
BIAs anlegen, bearbeiten, einreichen und freigeben dürfen Space-Mitglieder mit der Rolle **Mitglied** oder **Administrator**. Die Rolle **Betrachter** hat ausschließlich Lesezugriff auf die BIA und ihre Historie.

Die einmaligen **Bewertungsgrundlagen** (Bewertungsskalen, Zeitfenster und BCM-Einstellungen inklusive Self-Approve-Modus) richtet dagegen ein **Administrator** ein.

Im **4-Augen-Modus** (Standard) muss der Freigebende eine **andere Person** sein als der Einreicher; ein Ein-Personen-Space kommt so nicht durch. Für solche Fälle aktiviere **Self-Approve** (siehe „Freigabe-Ablauf"), dann darf dieselbe Person einreichen und freigeben.
