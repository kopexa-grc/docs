...
description: So legst du einen neuen Lieferanten im Kopexa Lieferanten-Modul an und klassifizierst ihn.
---

Neue Lieferanten werden im **Lieferanten-Modul** zentral erfasst. Dies schafft die Grundlage für Risikoanalysen, Sicherheitsbewertungen und Audits.
...
2. **Basisinformationen erfassen:**
   ...
   ![Dialog „Neuen Lieferant erstellen“](./images/vendors-create.png)

3. **Weitere Angaben (optional, aber empfohlen):**
   - **Kategorie/Kritikalität:** Kritisch/nicht-kritisch – dient der späteren Priorisierung.
   - **Primärer Ansprechpartner:** Verantwortliche Person im Unternehmen für diesen Lieferanten.
