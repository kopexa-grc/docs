...
title: Lieferanten
icon: Store
description: Überblick über das Lieferanten-Modul – was es kann, warum es wichtig ist und wie du es effektiv in Kopexa nutzt.
---
...
2. **Erstellung (Create)** – Neues Lieferanten-Profil anlegen mit Website, Beschreibung und Klassifizierung  
...
5. **Verknüpfungen** – Zu Risiken, Kontrollen, Policies, Aufgaben, Verarbeitungstätigkeiten oder Vorfall-Ereignissen
...
- **[Best Practices](./best-practices.mdx)** – Klassifizierung, DSAR-Handling, Integration der Vorfallreaktion  
