...
### Access Kontrolle (Zugriffssteuerung)
...
### Annex A (ISO 27001)
Anhang der ISO 27001:2022 mit 93 Sicherheitskontrollen (Security Kontrollen), gegliedert in vier Kategorien: Organisational (37 Kontrollen), People (8 Kontrollen), Physical (14 Kontrollen) und Technological (34 Kontrollen). Ersetzt die vorherige Version mit 114 Kontrollen.
...
### Catalog (Framework)
Sammlung von Kontrollen (Kontrollen) und Anforderungen, z. B. ISO 27001, NIS2, TISAX.
...
### Review Cycle
Regelmäßige Überprüfung (Dokument, Risiko, Kontrolle).
...
ISO 27001 Pflichtdokument: Übersicht relevanter Kontrollen mit Begründungen für Einschluss oder Ausschluss sowie Implementierungsstatus.
