...
- **Identitätszuordnung:** Verknüpfen Sie eine oder mehrere Unternehmensdomains (z. B. `example.com`), um Benutzer automatisch Ihrer Organisation zuzuordnen.
...
- **Konsistente Verwaltung:** Mehrere Spaces innerhalb einer Organisation können dieselben zentral hinterlegten Domains für Authentifizierung und Benutzerzuordnung verwenden.

## Kopexa & Security für alle

Bei **Kopexa** ist Sicherheit **nicht nur Enterprise-Kunden vorbehalten**.  
**Jede Organisation**, unabhängig von Größe oder Tarif (Free, Lite, Pro, Enterprise), erhält:
...
Domains werden **auf Organisation-Ebene** konfiguriert. Im Bereich **Settings → Domains** können Sie:
...
4. **Benutzerzuordnung:** Benutzer mit passenden E-Mail-Domains werden automatisch der Organisation zugeordnet oder können gezielt eingeladen werden.
...
Domains gelten **organisationsweit** und betreffen alle **Spaces** innerhalb der Organisation.  
...
- [Organisation](../index.mdx) – Zentrale Verwaltung Ihrer Organisation und Benutzer  
