...
> **Hinweis:** Operative Internet-Domains (z. B. für Subdomain-Scanning) gehören zum [Inventory eines Space](../../../organization/assets/index.mdx).  
> SSO-Domains werden hier auf **Organisation-Level** gepflegt.

---

## 1. Neue Domain hinzufügen

1. Gehe zu: **Settings → Organisation → Domains**  
