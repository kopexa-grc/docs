...
- **SSO für alle:** Jede [Organisation](./index.mdx), unabhängig vom Tarif, kann [SAML](./domains/index.mdx) und OIDC nutzen. Security ist bei uns kein Enterprise-Add-on.
...
Kopexa nutzt ein **Relationship-based Access Kontrolle (ReBAC)**-Modell, implementiert mit [OpenFGA](https://openfga.dev/):
...
- **Mandantenfähigkeit:** Klare Trennung und Isolation zwischen Organisationen und Spaces.
- **Dynamische Policies:** Feingranulare Regeln wie „Benutzer darf nur Nachweise sehen, die zu seinen Assets gehören“.
- **Auditierbarkeit:** Jede Zugriffsentscheidung ist nachvollziehbar und protokollierbar.
- **OWASP ASVS-konform:** Effektive Abwehr von Broken Access Kontrolle (OWASP A01).

## Bedrohungsmodelle & OWASP Bezug

Wir adressieren Risiken aus [OWASP Top 10](https://owasp.org/www-project-top-ten/) und ASVS aktiv:

- **A01 Broken Access Kontrolle:** ReBAC mit OpenFGA, konsequente Berechtigungsprüfungen.
...
- [Organisation](./index.mdx) – Zentrale Verwaltung von Benutzern, SSO und Lizenzen  
