/** biome-ignore-all lint/suspicious/noArrayIndexKey: decorative pixel row with static order */
...
export async function GET(request: NextRequest) {
	...
	const description =
		searchParams.get("description") || "GRC Platform für moderne Unternehmen";
