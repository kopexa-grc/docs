		...
		stages: [
			{
				...
				enemies: [{ type: "risk", count: 5, pattern: "swoop" }],
			},
			{
				name: "Risk Assessment",
				enemies: [
					{ type: "risk", count: 4, pattern: "dive" },
					{ type: "vulnerability", count: 3, pattern: "zigzag" },
				],
			},
			{
				name: "Control Selection",
				enemies: [
					{ type: "threat", count: 3, pattern: "circle" },
					{ type: "vulnerability", count: 4, pattern: "swoop" },
				],
			},
			{
				name: "Implementation Review",
				enemies: [
					{ type: "threat", count: 5, pattern: "zigzag" },
					{ type: "risk", count: 3, pattern: "dive" },
				],
			},
			{
				name: "The Certification Audit",
				isBoss: true,
				bossHealthOverride: 30,
				enemies: [],
			},
		],
	},
		...
		stages: [
			{
				...
				enemies: [{ type: "risk", count: 4, pattern: "swoop" }],
			},
			{
				name: "Incident Reporting",
				enemies: [{ type: "vulnerability", count: 5, pattern: "dive" }],
			},
			{
				name: "Resilience Testing",
				enemies: [
					{ type: "threat", count: 3, pattern: "zigzag" },
					{ type: "risk", count: 3, pattern: "circle" },
				],
			},
			{
				...
				enemies: [
					{ type: "vulnerability", count: 4, pattern: "swoop" },
					{ type: "threat", count: 2, pattern: "dive" },
				],
			},
			{
				name: "Information Sharing",
				enemies: [{ type: "risk", count: 6, pattern: "zigzag" }],
			},
			{
				name: "Governance Review",
				enemies: [
					{ type: "threat", count: 4, pattern: "circle" },
					{ type: "vulnerability", count: 3, pattern: "swoop" },
				],
			},
			{
				name: "Compliance Verification",
				enemies: [
					{ type: "threat", count: 5, pattern: "dive" },
					{ type: "risk", count: 4, pattern: "zigzag" },
				],
			},
			{
				name: "The Supervisory Exam",
				isBoss: true,
				bossHealthOverride: 45,
				enemies: [],
			},
		],
	},
	{
		...
		stages: [
			...
			},
			{
				...
				enemies: [
					{ type: "vulnerability", count: 4, pattern: "dive" },
					{ type: "risk", count: 3, pattern: "zigzag" },
				],
			},
			{
				name: "Access Controls",
				enemies: [{ type: "threat", count: 4, pattern: "circle" }],
			},
			{
				name: "Encryption Review",
				enemies: [
					{ type: "vulnerability", count: 5, pattern: "swoop" },
					{ type: "threat", count: 2, pattern: "dive" },
				],
			},
			{
				...
				enemies: [
					{ type: "risk", count: 4, pattern: "zigzag" },
					{ type: "vulnerability", count: 4, pattern: "circle" },
				],
			},
			{
				name: "Business Continuity",
				enemies: [
					{ type: "threat", count: 5, pattern: "swoop" },
					{ type: "risk", count: 3, pattern: "dive" },
				],
			},
			{
				...
				enemies: [
					{ type: "vulnerability", count: 6, pattern: "zigzag" },
					{ type: "threat", count: 2, pattern: "circle" },
				],
			},
			{
				name: "Cross-Border Ops",
				enemies: [
					{ type: "threat", count: 4, pattern: "dive" },
					{ type: "risk", count: 4, pattern: "swoop" },
					{ type: "vulnerability", count: 3, pattern: "zigzag" },
				],
			},
			{
				...
				enemies: [
					{ type: "threat", count: 6, pattern: "circle" },
					{ type: "vulnerability", count: 4, pattern: "dive" },
				],
			},
			{
				name: "The EU Regulator",
				isBoss: true,
				bossHealthOverride: 60,
				enemies: [],
			},
		],
	},
	...
	if (shieldLevel > 0) {
		...
		for (let i = 0; i < shieldLevel; i++) {
			...
			ctx.ellipse(
				x + PLAYER_WIDTH / 2,
				y + PLAYER_HEIGHT / 2,
				PLAYER_WIDTH / 2 + 8 + grow,
				PLAYER_HEIGHT / 2 + 6 + grow,
				0,
				0,
				Math.PI * 2,
			);
...
function drawPowerUp(
	...
	if (type === "shield") {
		...
		// Second row
		ctx.fillRect(4, p, 4, p);
		ctx.fillRect(20, p, 4, p);
		// Sides
		ctx.fillRect(2, p * 2, 4, p * 8);
		ctx.fillRect(22, p * 2, 4, p * 8);
		// Inner fill
		ctx.fillStyle = d;
		ctx.fillRect(6, p, 16, p * 9);
		// Bottom taper
		ctx.fillStyle = c;
		ctx.fillRect(4, p * 10, 4, p);
		ctx.fillRect(20, p * 10, 4, p);
		ctx.fillRect(6, p * 11, 4, p);
		ctx.fillRect(18, p * 11, 4, p);
		...
		// S
		ctx.fillRect(11, p * 3, p * 2, p);
		ctx.fillRect(11, p * 4, p, p);
		ctx.fillRect(11, p * 5, p * 2, p);
		ctx.fillRect(12, p * 6, p, p);
		ctx.fillRect(11, p * 7, p * 2, p);
		// O
		ctx.fillRect(15, p * 3, p * 2, p);
		ctx.fillRect(14, p * 4, p, p * 2);
		ctx.fillRect(17, p * 4, p, p * 2);
		ctx.fillRect(15, p * 6, p * 2, p);

		// Checkmark
		ctx.fillStyle = "#22c55e";
		ctx.fillRect(10, p * 8, p, p);
		ctx.fillRect(11, p * 9, p, p);
		ctx.fillRect(12, p * 8, p, p);
		ctx.fillRect(13, p * 7, p, p);
		ctx.fillRect(14, p * 6, p, p);
	} else if (type === "rapid") {
		// =========================================================================
		...
		// x
		ctx.fillRect(19, 20, p, p);
		ctx.fillRect(21, 20, p, p);
		ctx.fillRect(20, 21, p, p);
		ctx.fillRect(19, 22, p, p);
		ctx.fillRect(21, 22, p, p);
		// 3
		ctx.fillRect(23, 20, p * 2, p);
		ctx.fillRect(24, 21, p, p);
		ctx.fillRect(23, 22, p * 2, p);
		ctx.fillRect(24, 23, p, p);
...
export function ComplianceRunner() {
	...
	const spawnMissionStage = useCallback(
		(stage: MissionStage, waveNum: number) => {
			const game = gameRef.current;
			const diff = DIFFICULTIES[game.difficulty];
				...
				for (let i = 0; i < group.count; i++) {
					...
					setTimeout(() => {
						...
						const health = Math.max(
							1,
							Math.round(baseHealth * diff.healthMult),
						);
		...
		for (let i = 0; i < 8; i++) {
			setTimeout(() => {
				...
				game.powerUps.push({
					...
					y: -20 - Math.random() * 40,
					type: (["shield", "rapid", "multi"] as const)[
	...
	const pickWaveModifier = useCallback(
		(
			waveNum: number,
		): {
			...
			if (cycle === 5) {
				...
				const stage =
					regularStages[Math.floor(Math.random() * regularStages.length)];
				return {
					modifier: "mission-stage",
					label: `${mission.name}: ${stage.name}`,
					stage,
				};
			}
	...
	const handleMenuSelect = useCallback(() => {
		...
		if (game.menuScreen === "main") {
			...
			setDisplayState((s) => ({
				...s,
				menuScreen: "difficulty" as MenuScreen,
			}));
		...
		const handleKeyDown = (e: KeyboardEvent) => {
			...
			if (game.state === "idle") {
				if (e.key === "ArrowUp") {
					e.preventDefault();
					game.menuCursor =
						(game.menuCursor - 1 + getMenuItemCount()) % getMenuItemCount();
					return;
				}
				if (e.key === "ArrowDown") {
					e.preventDefault();
			...
			if (
				["ArrowLeft", "ArrowRight", "Space", " ", "a", "d", "A", "D"].includes(
					e.key,
				)
			) {
				e.preventDefault();
	...
	}, [canRestart, handleMenuSelect, handleMenuBack, getMenuItemCount]);
	...
	}, [canRestart, handleMenuSelect]);

	// Virtual control button handlers
	const handleControlStart = useCallback(
		(control: "left" | "right" | "shoot") => {
	...
	useEffect(() => {
		...
		const gameLoop = () => {
			...
			if (game.state === "playing") {
				...
				if (game.shieldLevel > 0 && now > game.shieldEndTime)
					game.shieldLevel = 0;
				if (game.rapidLevel > 0 && now > game.rapidFireEndTime)
					game.rapidLevel = 0;
				if (game.multiLevel > 0 && now > game.multiShotEndTime)
					game.multiLevel = 0;
				...
				const fireRate =
					RAPID_FIRE_RATES[Math.min(game.rapidLevel, MAX_POWER_LEVEL)];
				...
				game.enemies = game.enemies.map((e) => {
					...
					switch (e.pattern) {
						...
						case "circle": {
							...
							e.x =
								GAME_WIDTH / 2 +
								Math.cos(e.angle + e.id * 0.5) * (140 + Math.sin(t * 0.5) * 20);
						...
						case "boss": {
							...
							if (e.y < e.startY) {
								...
								const dropChance =
									(0.008 + game.wave * 0.002) *
									DIFFICULTIES[game.difficulty].dropMult;
					...
					const enemyDropChance =
						(0.001 + game.wave * 0.0003) *
						DIFFICULTIES[game.difficulty].dropMult;
				...
				game.bullets = game.bullets.filter((bullet) => {
					for (const enemy of game.enemies) {
						...
						const eh =
							enemy.type === "boss" ? ENEMY_HEIGHT * 2.5 : ENEMY_HEIGHT;
							...
							if (enemy.health <= 0) {
								...
								for (let i = 0; i < 15; i++) {
									game.particles.push({
										...
										life: 1,
										color:
											Math.random() > 0.5 ? "#ffffff" : COLORS.playerAccent,
				...
				if (
					!game.rewardWaveActive &&
					game.waveEnemiesKilled >= game.waveTarget &&
					game.waveTarget > 0 &&
				...
				if (
					!game.bossWave &&
					game.waveModifier !== "mission-stage" &&
					game.waveModifier !== "boss-rush" &&
					game.wave >= 3 &&
					game.enemies.length < 2 &&
					game.waveEnemiesKilled < game.waveTarget - 3
				) {
					spawnFormation(game.wave);
				}
				...
				game.powerUps.forEach((p) => {
					drawPowerUp(ctx, p, game.frame);
				});
				game.findings.forEach((f) => {
					drawFinding(ctx, f, game.frame);
				});
				game.enemies.forEach((e) => {
					drawEnemy(ctx, e, game.frame);
				});
				game.bullets.forEach((b) => {
					drawBullet(ctx, b.x, b.y, b.angle);
				});
				...
				if (
					...
					ctx.textBaseline = "middle";
					const modColor =
						game.waveModifier === "shadow-audit"
							? "#a855f7"
							: game.waveModifier === "mission-stage"
								? "#22d3ee"
								: "#ec4899";
			...
			if (game.state === "idle") {
				...
				const drawMenuItem = (
					...
					ctx.fillStyle =
						color || (isSelected ? COLORS.playerAccent : COLORS.text);
				...
				if (game.menuScreen === "main") {
					...
					ctx.fillText(
						"Survive Audits, Shadow IT & Regulatory Fines!",
						GAME_WIDTH / 2,
						90,
					);
					...
					ctx.font = "11px monospace";
					ctx.fillText(
						"Power-ups stack! Collect same type to upgrade (max Lv5)",
						GAME_WIDTH / 2,
						225,
					);
					...
					ctx.fillText(
						"← → / A D = Move | SPACE = Shoot | ↑↓ = Menu | ENTER = Select",
						GAME_WIDTH / 2,
						260,
					);
					...
					const diffs: { key: Difficulty; label: string; desc: string }[] = [
						{
							key: "easy",
							label: "EASY",
							desc: "Slower enemies, weaker foes, longer power-ups",
						},
						{
							key: "normal",
							label: "NORMAL",
							desc: "The standard compliance experience",
						},
						{
							key: "hard",
							label: "HARD",
							desc: "Faster enemies, tougher foes, shorter power-ups",
						},
					];
					diffs.forEach((d, i) => {
						const y = 230 + i * 65;
					...
					ctx.fillText(
						"Dynamic events: Shadow Audits • Mission Stages • Boss Rushes",
						GAME_WIDTH / 2,
						440,
					);
					ctx.fillText(
						"Boss every 5 waves • Reward waves after bosses",
						GAME_WIDTH / 2,
						456,
					);
				}
	...
	const {
		...
		lives,
		wave,
		shieldLevel: dispShield,
		rapidLevel: dispRapid,
		multiLevel: dispMulti,
		difficulty: dispDiff,
		waveModifier: dispModifier,
		waveModifierLabel: dispModLabel,
	} = displayState;
	...
	}, [showShareCard, generateScorecard]);
			...
			>
				...
				<div className="flex flex-wrap justify-center gap-3 sm:gap-6 w-full max-w-[800px] px-2 text-xs sm:text-sm font-mono font-bold">
					...
					{gameState === "playing" && dispModifier && dispModLabel && (
						<span
							className={`text-xs px-1.5 py-0.5 rounded font-bold ${
								dispModifier === "shadow-audit"
									? "bg-[#a855f7]/30 text-[#a855f7]"
									: dispModifier === "mission-stage"
					...
					{gameState === "playing" && (
						<span
							...
							style={{
								backgroundColor: `${DIFFICULTIES[dispDiff].color}30`,
								color: DIFFICULTIES[dispDiff].color,
							}}
						>
				...
				<canvas
					...
					style={
						isFullscreen
							? {
									width: "min(100%, calc(100vh - 120px) * 4 / 3)",
									height: "auto",
				...
				{isTouchDevice && (
					<div className="flex justify-between items-center w-full max-w-[500px] px-4 mt-2 sm:hidden">
						...
						<button
							...
							onTouchStart={(e) => {
								e.preventDefault();
								handleControlStart("shoot");
							}}
							onTouchEnd={(e) => {
								e.preventDefault();
								handleControlEnd("shoot");
							}}
							onTouchCancel={(e) => {
								e.preventDefault();
								handleControlEnd("shoot");
			...
			{showSettings && (
				<div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[60] p-4">
					<div className="bg-[#0F263E] border-2 border-[#22d3ee]/50 rounded-xl p-4 sm:p-6 max-w-sm w-full flex flex-col gap-4">
						<h3 className="text-[#22d3ee] font-mono font-bold text-lg text-center">
							Settings
						</h3>
						...
						<div className="flex items-center justify-between">
							...
							>
								<div
									className={`w-6 h-6 bg-white rounded-full transition-transform mx-1 ${soundEnabled ? "translate-x-6" : ""}`}
								/>
							</button>
						</div>
			...
			{showShareCard && (
				<div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[60] p-4">
					<div className="bg-[#0F263E] border-2 border-[#22d3ee]/50 rounded-xl p-4 sm:p-6 max-w-lg w-full flex flex-col items-center gap-4">
						<h3 className="text-[#22d3ee] font-mono font-bold text-lg">
							Share Your Score
						</h3>
						...
						<div className="w-full">
							<label
								htmlFor="nickname"
								className="text-white/70 font-mono text-xs mb-1 block"
							>
								Enter your nickname:
							</label>
							<input
