...
const Robot = ({
	...
	<svg viewBox="0 0 40 40" className={className} aria-hidden="true">
		...
		<rect
			...
			width="2"
			height="2"
			fill={isWaving ? "#22c55e" : frame === 0 ? "#22c55e" : "#0F263E"}
		/>
...
const UFO = ({
	...
	<svg viewBox="0 0 48 40" className={className} aria-hidden="true">
		...
		<rect
			...
			width="3"
			height="3"
			fill={beamFrame === 0 ? "#22d3ee" : "#0F263E"}
		/>
		<rect
			x="16"
			y="14"
			width="3"
			height="3"
			fill={beamFrame === 0 ? "#0F263E" : "#22d3ee"}
		/>
		<rect
			x="24"
			y="14"
...
const RunningPerson = ({
	...
	<svg viewBox="0 0 16 24" className={className} aria-hidden="true">
		...
		<rect x="7" y="5" width="2" height="2" fill="#22d3ee" />{" "}
		{/* Logo on shirt */}
	...
	return (
		<div className="absolute inset-0 overflow-hidden pointer-events-none">
			...
			>
				<Bird
					frame={frame}
					className="w-4 h-3 text-primary-700/40 dark:text-primary-300/30"
				/>
			</div>
			<div
			...
			>
				<Bird
					frame={(frame + 1) % 2}
					className="w-3 h-2 text-primary-600/35 dark:text-primary-400/25"
				/>
			</div>
			...
			>
				<Robot
					frame={frame}
					isWaving={isWaving}
					className="w-12 h-14 opacity-90 sm:w-10 sm:h-12"
				/>
			</button>
		</div>
	);
