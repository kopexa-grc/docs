...
export const FOOTER_LINKS = {
	...
	company: [
		{
			label: "Impressum",
			href: `${KOPEXA_URL}/de/legal/imprint`,
			external: true,
		},
		{
			label: "Datenschutz",
			href: `${KOPEXA_URL}/de/legal/privacy`,
			external: true,
		},
		{
			label: "Cookies",
			href: `${KOPEXA_URL}/de/legal/cookies`,
			external: true,
		},
		{
			label: "Barrierefreiheit",
			href: `${KOPEXA_URL}/de/legal/accessibility-statement`,
			external: true,
		},
		{
			label: "Modern Slavery Act",
			href: `${KOPEXA_URL}/de/legal/modern-slavery-statement`,
			external: true,
		},
		{
			label: "Security",
			href: `${KOPEXA_URL}/de/legal/security`,
			external: true,
		},
		{
			label: "SLA",
			href: `${KOPEXA_URL}/de/legal/service-level-agreement`,
			external: true,
		},
	],
} as const;
